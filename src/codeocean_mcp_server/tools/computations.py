...
def add_tools(mcp: FastMCP, client: CodeOcean):
    ...
    @mcp.tool(
        description=(
            client.computations.run_capsule.__doc__
            + ADDITIONAL_INSTRUCTIONS["run_capsule"]
        )
    )
    ...
    def wait_until_completed(computation_id: str) -> ComputationModel:
        ...
        return client.computations.wait_until_completed(
            computation=computation
        )

    @mcp.tool(
        description=(
            client.computations.list_computation_results.__doc__
    ...
    @mcp.tool(
        description=(
            client.computations.get_result_file_download_url.__doc__
        )
    )
    ...
    @mcp.tool(
        description=(
            "Use when you want to read the content of a file "
            "from a computation"
        )
    )
